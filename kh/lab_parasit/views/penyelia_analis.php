      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_parasit/report/print/print_usulan_penunjukan_multi_periode.php" method="post" target="_blank">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body" id="modal-print">
          ...
          <div id="responsive-form" class="clearfix">
                ...
                <form action="./lab_parasit/report/print/print_surat_tugas_multi_periode.php" method="post" target="_blank">
