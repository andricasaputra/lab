    ...
    $subdata = array();
        ...
        if(strlen($isi) == 0){
            ...
            $subdata[] = '
                ...
                <a href="./lab_parasit/report/print/print_surat_hasil_uji.php?id='.$data2->id.'" target="_blank"><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-print fa-fw"></i> Print</button></a>
                ';
