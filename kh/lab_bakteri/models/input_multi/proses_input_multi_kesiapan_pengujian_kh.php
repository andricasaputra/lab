...
$sql = $conn->query("SELECT kode_sampel,mt FROM input_permohonan_kh WHERE kode_sampel !='' AND mt = ''");
...
if ($cek == 0) {
 ...
 if($mt !=="") {
	 ...
	 $objectData->edit("UPDATE input_permohonan_kh SET kondisi_sampel='$kondisi_sampel', mt='$mt', nip_mt='$nip_mt', penyelia='$penyelia', penyelia2='$penyelia2', analis='$analis',  analis2='$analis2' , bahan='$bahan', bahan2='$bahan2', alat='$alat', alat2='$alat2', kesiapan='$kesiapan' WHERE kode_sampel != '' AND mt = ''");
